...
namespace Lab8
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            probT[3] = (double)tbpr4.Value; probT[4] = (double)tbpr5.Value; probT[5] = (double)tbpr6.Value; probT[6] = 1;
            for (int i = 0; i < 6; i++) probT[6] -= probT[i]; tbpr7.Text = probT[6].ToString();
